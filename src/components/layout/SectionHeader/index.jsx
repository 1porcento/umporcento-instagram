...
export default function SectionHeader(){
  return(
    <Container>
      ...
      <VideoFrame src="https://player.vimeo.com/video/1012853743?title=0&byline=0&portrait=0&controls=1&autoplay=1" frameborder="0" allow="autoplay; fullscreen" allowfullscreen />
